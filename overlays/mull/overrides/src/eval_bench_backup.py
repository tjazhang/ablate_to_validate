...
def main():
  ...
  dataset_entries = [
      ...
      #    "vsibench_location": (
      #        "./src/r1-v/Evaluation/Video-R1-eval/eval_vsibench.json"
      #    ),
  ...
  for dataset_entry in dataset_entries:
    ...
    #PROMPT_PATH = (
    #    f"./src/r1-v/Evaluation/Video-R1-eval/eval_{dataset_name}.json"
    #)
    ...
    QUESTION_TEMPLATE = (
        ...
        " pondering deeply. Engage in an internal dialogue using expressions"
        " such as 'let me think', 'wait', 'Hmm', 'oh, I see', 'let's break it"
        " down', etc, or other natural language thought expressions It's"
        " encouraged to include self-reflection or verification in the"
        " reasoning process. Provide your detailed reasoning between the"
        " <think> and </think> tags, and then give your final answer between"
        " the <answer> and </answer> tags."
    )
