...
NEW: Upstream-tracked path: qwen-vl-finetune/README.md
-->

# QwenVL Training Framework

Release note: the cleaned Aurora-vs-upstream summary lives in `../AURORA_RELEASE.md`, the end-user run guide lives in `../USER_GUIDE.md`, and the public example launchers are `scripts/train_ade_*.sh` plus `eval_qwen.sh`.
