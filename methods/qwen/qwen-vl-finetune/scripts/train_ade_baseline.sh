...
# NEW: Aurora path: qwen-vl-finetune/scripts/train_ade_baseline.sh
...
TRAIN_JSON="${TRAIN_JSON:?Set TRAIN_JSON to the baseline training JSON (for example a mixed_depth_short JSON).}"
...
RUN_NAME="${RUN_NAME:-qwen2.5vl-3b-ade-baseline-${NUM_EPOCHS}ep}"
